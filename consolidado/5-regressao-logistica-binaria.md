# Entrega 02 — Regressão Logística Binária
...
Notebook destinado à construção e à avaliação de um modelo de regressão logística para uma variável de resposta binária.
